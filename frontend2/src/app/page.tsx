...
import { WireframeButton, WireframeCard, WireframeCardIcon, WireframeCardBody, WireframeNavigation } from "@/components/wireframe"
...
export default function HomePage() {
  return (
    <div className="page-home min-h-screen">
      ...
      <main>
        {/* Hero Section */}
        <section className="text-center pt-24 pb-8 relative">
          {/* Radial gradient background effect */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-radial from-wireframe-blue/10 to-transparent rounded-full -z-10" />
          ...
          <div className="container max-w-[1400px] mx-auto px-6">
            ...
            <div className="flex justify-center gap-6 flex-wrap mb-4">
              <Link href="/jobs">
                <WireframeButton variant="primary" size="lg">
                  Browse Positions
                </WireframeButton>
              </Link>
              <Link href="/login">
                <WireframeButton variant="secondary" size="lg">
        ...
        {/* Features Section */}
        <section className="container max-w-[1400px] mx-auto px-6 mb-16" id="features">
