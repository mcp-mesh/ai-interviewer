  ...
  return (
    <header className={cn(
      ...
      <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center h-16">
        ...
        <Link 
          href="/" 
          className="flex items-center gap-3 font-bold text-xl text-white no-underline transition-all duration-300 hover:-translate-y-px"
        >
        ...
        <div className="flex items-center gap-4">
          <nav className="hidden md:flex items-center gap-1">
            <Link 
              href="#features" 
              className="text-white no-underline px-4 py-2 rounded-lg transition-all duration-200 font-medium hover:text-white hover:bg-white/10"
            >
              Features
            </Link>
            <Link 
