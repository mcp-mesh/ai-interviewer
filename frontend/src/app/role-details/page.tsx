...
function RoleDetailsContent() {
  ...
  const [data, setData] = useState<RoleDetailsResponse | null>(null)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg p-6 flex items-center space-x-3">
          ...
          <span className="text-gray-700">Loading role details...</span>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">Role Details</h1>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">{data.role.title}</h2>
              <div className="text-gray-600 text-base mb-4 prose prose-base max-w-none">
                <ReactMarkdown
                  components={{
              ...
              <div className="flex items-center space-x-4">
                {getStatusBadge(data.role.status)}
                <span className="text-sm text-gray-500">
                  Created by {data.role.created_by} on {formatDate(data.role.created_at)}
                </span>
              </div>
            </div>
          </div>
          ...
          {sortedInterviews.length > 0 ? (
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            {expandedRows.has(interview.session_id) ? 
                              <ChevronUpIcon className="w-4 h-4 text-gray-400 mr-2" /> :
                            ...
                            {loadingDetails ? (
                              ...
                              <div className="space-y-6">
                                ...
                                <div>
                                  ...
                                  <div className="bg-white rounded-lg p-4 text-sm text-gray-700 prose prose-sm max-w-none">
                                    <ReactMarkdown
                                      components={{
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                No candidates have interviewed for this role yet.
              </p>
            </div>
          )}
        </div>
